...
using Buoi07_entityfrw.Models;

namespace Buoi07_entityfrw.Controllers
{
    public class SanPhamsController : Controller
    {
        private readonly WebDbContext _context;

        public SanPhamsController(WebDbContext context)
        {
            _context = context;
        }
        ...
        {
            var webDbContext = _context.SanPhams.Include(s => s.MaLoaiNavigation);
